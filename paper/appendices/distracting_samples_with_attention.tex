...
\begin{figure*}[ht]
    ...
    \vspace{\floatsep}
    \subfloat[a][Adversarial Image $epsilon=0.080, N=100$]{\includegraphics[width=0.45\textwidth]{figures/Distract/e0.080_n100/img_34.jpg}
    }
    \vspace{\floatsep}
    \subfloat[a][Clean Image with attention]{\includegraphics[width=0.45\textwidth]{figures/Distract/e0.000_n100/caption_34.png}
    }
    \vspace{\floatsep}
    \subfloat[a][Adversarial Image $epsilon=0.080, N=100$]{\includegraphics[width=0.45\textwidth]{figures/Distract/e0.080_n100/caption_34.png}
    }
\end{figure*}