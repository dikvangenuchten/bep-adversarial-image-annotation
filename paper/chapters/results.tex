...
The attention and sentence generation for figure \ref{fig:full_img_clean_field} are visualized in figure \ref{fig:distract_field_all}. The attention is focused on the correct parts of the image. The model is completely distracted and attends solely to the top-left part.
