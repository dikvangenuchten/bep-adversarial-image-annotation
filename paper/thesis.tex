...
\input{appendices/adversarial_samples_various_epsilon}
...
\input{appendices/distracting_samples_various_epsilon}
\newpage
\section{Distraction samples with attention}\label{appendix:distracting_samples_with_attention}
\input{appendices/distracting_samples_with_attention}
\newpage
