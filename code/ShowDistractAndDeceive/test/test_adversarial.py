...
def test_generate_adversarial_example(
    ...
    # plt.imsave(
    #     f"samples/adversarial_noise_{epsilon:2.2f}.jpg",
    #     rescale(adversarial_noise.detach().cpu().permute(1, 2, 0)).numpy(),
    # )
    # plt.imsave(
    #     f"samples/adversarial_sample_{epsilon:2.2f}.jpg",
    #     rescale(adversarial_sample.detach().cpu().permute(1, 2, 0)).numpy(),
    # )
    # with open(f"samples/adversarial_sample_{epsilon:2.2f}.txt", "w") as file:
